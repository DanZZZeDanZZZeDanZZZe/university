...
function getHitRate({randomNumbers, numberOfIntervals, intervalStart, intervalEnd}) {
  const prob = getPossibleProbabilities({numberOfIntervals, intervalStart, intervalEnd})
  const ranges = getRanges({prob, intervalEnd})
